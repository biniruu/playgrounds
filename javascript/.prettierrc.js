 ...
 * plugins > @prettier/plugin-pug : pug 파일 formatting
 * plugins > prettier-plugin-tailwindcss : prettier가 prettier-plugin-tailwindcss를 자동으로 로딩하지 않을 경우 plugins에 prettier-plugin-tailwindcss가 있음을 명시해야 한다.
